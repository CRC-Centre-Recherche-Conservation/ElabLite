...
TECHNIQUES = OrderedDict([
    ...
    ("CE-MS", TechniqueOption("CE-MS", "Electrophorèse capillaire couplée à la spectrométrie de masse",
    ...
    ("FORS",
     TechniqueOption("FORS", "Fiber optical reflectance spectroscopy", "Fiber Optical Reflectance Spectroscopy")),
    ("GC-MS", TechniqueOption("GC-MS", "Chromatographie en phase gazeuse couplée à la spectrométrie de masse",
                              "Gas Chromatography-Mass Spectrometry")),
    ("GC-2D-MS",
     TechniqueOption("GC-2D-MS", "Chromatographie en phase gazeuse à 2 dimensions couplée à la spectrométrie de masse",
                     "Two-Dimensional Gas Chromatography-Mass Spectrometry")),
    ("IR", TechniqueOption("IR", "Photographie infrarouge", "Infrared Photography")),
    ("IRFC", TechniqueOption("IRFC", "Image fausse couleur avec photographie infrarouge",
                             "False Color Image with Infrared Photography")),
    ("IRTF", TechniqueOption("IRTF", "Spectroscopie infrarouge à transformée de Fourier",
                             "Fourier Transform Infrared Spectroscopy")),
    ("IRTF-ATR", TechniqueOption("IRTF-ATR", "Spectroscopie infrarouge à transformée de Fourier - mode réflectance",
                                 "Fourier Transform Infrared Spectroscopy – reflectance")),
    ("LC-MS", TechniqueOption("LC-MS", "Chromatographie en phase liquide couplée à la spectrométrie de masse",
                              "Liquid Chromatography-Mass Spectrometry")),
    ("MALDI-MS", TechniqueOption("MALDI-MS",
                                 "Spectromètre de masse couplée à une source d'ionisation laser assistée par une matrice",
    ...
    ("PTR-MS", TechniqueOption("PTR-MS", "Spectrométrie de masse par transfert de charge protonique",
    ...
    ("RIS-SWIR", TechniqueOption("RIS-SWIR", "Imagerie de réflectance hyperspectrale – domaine infrarouge",
                                 "Hyperspectral Reflectance Imaging – Short-Wave Infrared domain")),
    ("RIS-VNIR", TechniqueOption("RIS-VNIR", "Imagerie de réflectance hyperspectrale – domaine visible",
                                 "Hyperspectral Reflectance Imaging –Visible and Near-Infrared domain")),
    ...
    ("UVFC", TechniqueOption("UVFC", "Image fausse couleur avec photographie UVR",
                             "False Color Image with UV Reflectance Photography")),
    ...
    ("MOD_NUM", TechniqueOption("MOD_NUM", "Modèle numérique", "Numerical Model")),
    ("VIB", TechniqueOption("VIB", "Analyse vibratoire", "Vibration Analysis")),
    ("VIB_EXP_ANMOD", TechniqueOption("VIB_EXP_ANMOD", "Analyse modale expérimentale", "Experimental Modal Analysis")),
    ("VIB_NUM_ANMOD", TechniqueOption("VIB_NUM_ANMOD", "Analyse modale numérique", "Numerical Modal Analysis")),
    ("VIB_EXP_FRF", TechniqueOption("VIB_EXP_FRF", "Fonction de réponse en fréquence expérimentale",
                                    "Experimental Frequency Response Function")),
    ("VIB_NUM_FRF", TechniqueOption("VIB_NUM_FRF", "Fonction de réponse en fréquence numérique",
                                    "Numerical Frequency Response Function")),
    ("VIB_SURV", TechniqueOption("VIB_SURV", "Surveillance vibratoire", "Vibration Monitoring")),
    ("STAT_NUM", TechniqueOption("STAT_NUM", "Analyse statique numérique", "Numerical Static Analysis")),
    ("ACOU", TechniqueOption("ACOU", "Analyse acoustique", "Acoustic Analysis")),
    ("ACOU_FRF", TechniqueOption("ACOU_FRF", "Réponse impulsionnelle sonore", "Sound Impulse Response")),
    ("ACOU_HOLO", TechniqueOption("ACOU_HOLO", "Holographie acoustique", "Acoustic Holography")),
    ("ACOU_SON", TechniqueOption("ACOU_SON", "Enregistrement sonore", "Sound Recording")),
    ("ACOU_IMP_EXP", TechniqueOption("ACOU_IMP_EXP", "Impédance acoustique expérimentale",
                                     "Experimental Acoustic Impedance")),
    ("ACOU_IMP_NUM", TechniqueOption("ACOU_IMP_NUM", "Impédance acoustique numérique",
                                     "Numerical Acoustic Impedance")),
    ("ACOU_SIMSON", TechniqueOption("ACOU_SIMSON", "Simulation sonore numérique", "Numerical Sound Simulation")),
])
